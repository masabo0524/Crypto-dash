...
const CoinDetailPage = () => {
	...
	<div className="coin-details-container">
	    ...
	    {!loading && !error && (
		<>
		    <img alt={coin.name} src={coin.image.large} className='coin-details-image'/>
		    <p>{coin.description.en.split('. ')[0] + '.'}</p>

		    <div className="con-detail-info">
			...
			<h4>
			    24h Price Change: ${coin.market_data.price_change_percentage_24h.toFixed(2)}{' '}({coin.market_data.price_change_percentage_24h.toFixed(2)}%)
			</h4>
			<h4>
			    Total Supply:{' '}{coin.market_data.total_supply?.toLocaleString() || 'N/A'}
			</h4>
			<h4>
			    All-Time High: ${coin.market_data.ath.usd.toLocaleString()} on{' '}{new Date(coin.market_data.ath_date.usd).toLocaleString()}
			</h4>
			<h4>
			    All-Time Low: ${coin.market_data.atl.usd.toLocaleString()} on{' '}{new Date(coin.market_data.atl_date.usd).toLocaleString()}
			</h4>
			<h4>
